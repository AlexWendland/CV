...
\textsc{2023--Current} & \large{Engineer -- \textsc{Man Group, London}}\\
	& \vspace{-0.07 in}\begin{itemize}
		\item Increased developer experience of using data tooling by introducing pre-commit and ruff.
		\item Organised velocity day to upgrade package versions within data tooling.
		\item Prototyped streamlined support process to increase team developer time.
		\item On-boarded brand mapping data to increase data availability.
